...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_framework "${PODS_ROOT}/../../zqf_framework/App.framework"
  install_framework "${PODS_ROOT}/../../zqf_framework/Flutter.framework"
  install_framework "${PODS_ROOT}/../../zqf_framework/shared_preferences.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/zqFlutter-lib/zqFlutter_lib.framework"
fi
